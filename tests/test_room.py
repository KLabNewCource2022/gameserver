...
def test_room_1():
    ...
    response = client.post(
        ...
        json={"room_id": 884502, "select_difficulty": 1},
    )
    ...
    #     "/room/end",
    #     headers=_auth_header(),
    #     json={"room_id": 483496, "score": 1234, "judge_count_list": [4, 3, 2, 2, 2]},
    # )
    # assert response.status_code == 200
    ...
    #     "/room/end",
    #     headers=_auth_header(),
    #     json={"room_id": room_id, "score": 1234, "judge_count_list": [4, 3, 2, 2, 2]},
    # )
    # assert response.status_code == 200
    # print("room/end response:", response.json())
